...
def census_type1():
    ...
    if census_cfcity == '' or census_cfcity == census_c:
        ...
        census_add1 = census_p +census_city_choice
        m_city = 0
        if census_cfc == census_county or census_cfc == ''  :
            m_county = 2
        else:
    ...
    return census_raw1, census_address1, m_city, m_county,census_p, census_c, census_county
...
def census_type2():
    ...
    return census_raw2, census_address2, m_city, m_county,census_p, census_c, census_county
...
if __name__ =="__main__":
    ...
    for i in range(num_data):
        ...
        census_dict['id'] = i
        census_dict['ref'],census_dict['write'], census_dict['m_city'], census_dict['m_county'],census_dict['province'], census_dict['city'], census_dict['county']  = gen_census()
