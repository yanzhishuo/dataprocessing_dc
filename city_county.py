...
if __name__ =="__main__":
    ...
    # file = open('/home/yzs/gendata/census_citycounty_gen_0522_2000.json', 'w')
    file = open('/home/yzs/gendata/4_phone_census/zhe/census_city_county_gen_0530_' + str(num_data) + '.json', 'w')
    file.write(obj)
    file.close()
