...
# refdeduplication('census_county_gen_0522_3000','ref')
#type 1
Modal = ['', '啊', '哦']
title_pattern = ['', '我', '我的']
pronounce = ['那个', '']
...
def census_type1():
    ...
    return census_raw1, census_address1, m_county,census_c, census_county
...
def census_type2():
    ...
    return census_raw2, census_address2,m_county, census_c, census_county
...
if __name__ =="__main__":
    ...
    for i in range(num_data):
        ...
        census_dict['id'] = i
        census_dict['ref'],census_dict['write'],census_dict['m_county'], census_dict['city'], census_dict['county']  = gen_census()
    ...
    file = open('/home/yzs/gendata/census_municipalities_gen_0523_2000.json', 'w')
    file.write(obj)
    file.close()
