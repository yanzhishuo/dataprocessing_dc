...
def census_type1():
    ...
    return census_raw1, census_add1,census_province, census_city, census_county

def census_type2():
    census_add2 = choice(pro_city_county)
    census_province, census_city, census_county = cut(census_add2)
    census_raw2 = Modal[windex([9.5,0.3,0.2])]+title_pattern2[windex([7,3])]+verb2[windex([3,7])]+census_add2+tail[windex([3,7])]
    return census_raw2, census_add2,census_province, census_city, census_county
...
def gen_census():
    ...
    census_ref, census_write,  census_province, census_city,census_county=census_list[index]
    return census_ref, census_write, census_province, census_city,census_county
...
if __name__ =="__main__":
    ...
    for i in range(num_data):
        ...
        census_dict['id'] = i
        census_dict['ref'],census_dict['write'] ,census_dict['province'], census_dict['city'], census_dict['county']= gen_census()
    ...
    # file = open('/home/yzs/gendata/census_pcc_gen_0522_3000.json', 'w')
    file = open('/home/yzs/gendata/4_phone_census/chuan/census_procc_gen_0530_' + str(num_data) + '.json', 'w')
    file.write(obj)
    file.close()
