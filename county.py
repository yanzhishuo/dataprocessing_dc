...
def census_type1():
    ...
    if census_cfprovince == '' or census_cfprovince == census_p:
        ...
        if census_cfc == census_c or census_cfc == ''  :
            m_city = 2
            census_add1 = census_add1 + census_county
        else:
            census_add1 = census_add1 + census_city_choice+ census_county
            m_city = 0
    ...
    return census_raw1, census_address1, m_province, m_city,census_p, census_c, census_county
...
def census_type2():
    ...
    return census_raw2, census_address2, m_province, m_city,census_p, census_c, census_county
...
if __name__ =="__main__":
    ...
    for i in range(num_data):
        ...
        census_dict['id'] = i
        census_dict['ref'],census_dict['write'], census_dict['m_province'], census_dict['m_city'],census_dict['province'], census_dict['city'], census_dict['county']  = gen_census()
